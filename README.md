...
Пример использования реализованного функционала представлен в jupyter notebook `report.ipynb`, для реализованного функционала имеется документация в формате Google Style Docstring с описанием классов, методов и параметров. 
...
Архитектура предусматривает расширение через **mini-collectors** — отдельные классы для каждого типа вопросов, которые собирают необходимые типы вопросов :
